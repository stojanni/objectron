...
function displayVideoDetections(result) {
    ...
    for (let detection of result.detections) {
        ...
        label.innerText = `${detection.categories[0].categoryName.charAt(0).toUpperCase() + detection.categories[0].categoryName.slice(1)}`/* - ${Math.round(parseFloat(detection.categories[0].score) * 100)}% confidence.`*/
